 ...
 */
public class FgBaKrCidsLayer extends Default1505ConsideredCidsLayer {
     ...
     */
    public FgBaKrCidsLayer(final MetaClass mc, final User user) {
        super(
            mc,
            user,
            false,
