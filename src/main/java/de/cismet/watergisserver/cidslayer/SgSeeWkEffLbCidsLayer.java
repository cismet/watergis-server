 ...
 */
public class SgSeeWkEffLbCidsLayer extends WatergisDefaultCidsLayer {
...
//        CATALOGUE_NAME_MAP.put("wk_nr", "wk_nr");
     ...
     */
    public SgSeeWkEffLbCidsLayer(final MetaClass mc, final User user) {
    ...
    public void handleWk_nr(final MemberAttributeInfo attr,
        ...
        sb.add("dlm25w.k_wk_sg.wk_nr");
        columnNamesList.add("wk_nr");
        sqlColumnNamesList.add("dlm25w.k_wk_sg.wk_nr");
        ...
        joins.append(" left ").append(" join dlm25w.k_wk_sg on (dlm25w.sg_see_wk_eff_lb.wk_nr = dlm25w.k_wk_sg.id)");
