...
//        CATALOGUE_NAME_MAP.put("wk_nr", "wk_nr");
     ...
     */
    public GwWkCidsLayer(final MetaClass mc, final User user) {
    ...
    public void handleWk_nr(final MemberAttributeInfo attr,
        ...
        sb.add("dlm25w.k_wk_gw.wk_nr");
        columnNamesList.add("wk_nr");
        sqlColumnNamesList.add("dlm25w.k_wk_gw.wk_nr");
        ...
        joins.append(" left ").append(" join dlm25w.k_wk_gw on (dlm25w.gw_wk.wk_nr = dlm25w.k_wk_gw.id)");
        joins.append(" left ").append(" join dlm25w.k_bl on (dlm25w.k_wk_gw.wk_fedfue = dlm25w.k_bl.id)");
    }
}
