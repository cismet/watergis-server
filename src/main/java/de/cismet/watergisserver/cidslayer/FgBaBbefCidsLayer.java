 ...
 */
public class FgBaBbefCidsLayer extends Default1505ConsideredCidsLayer {
    ...
    static {
        CATALOGUE_NAME_MAP.put("bbef", "bbef");
     ...
     */
    public FgBaBbefCidsLayer(final MetaClass mc, final User user) {
        super(
            mc,
            user,
            false,
