 ...
 */
public class FgBaAnllCidsLayer extends Default1505ConsideredCidsLayer {
    ...
    static {
        CATALOGUE_NAME_MAP.put("anll", "anll");
     ...
     */
    public FgBaAnllCidsLayer(final MetaClass mc, final User user) {
        super(
            mc,
            user,
            false,
