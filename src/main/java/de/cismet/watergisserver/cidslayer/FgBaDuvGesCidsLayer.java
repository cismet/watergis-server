 ...
 */
public class FgBaDuvGesCidsLayer extends Default1505ConsideredCidsLayer {
     ...
     */
    public FgBaDuvGesCidsLayer(final MetaClass mc, final User user) {
    ...
    protected String getFieldRestriction(final String column) {
        if (column.equals("dlm25w.fg_ba.bemerkung")) {
