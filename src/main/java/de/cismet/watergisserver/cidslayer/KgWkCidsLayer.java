 ...
 */
public class KgWkCidsLayer extends WatergisDefaultCidsLayer {
...
//        CATALOGUE_NAME_MAP.put("wk_nr", "wk_nr");
     ...
     */
    public KgWkCidsLayer(final MetaClass mc, final User user) {
    ...
    public void handleWk_nr(final MemberAttributeInfo attr,
        ...
        sb.add("dlm25w.k_wk_kg.wk_nr");
        columnNamesList.add("wk_nr");
        sqlColumnNamesList.add("dlm25w.k_wk_kg.wk_nr");
        ...
        joins.append(" left ").append(" join dlm25w.k_wk_kg on (dlm25w.kg_wk.wk_nr = dlm25w.k_wk_kg.id)");
        joins.append(" left ").append(" join dlm25w.k_bl on (dlm25w.k_wk_kg.wk_fedfue = dlm25w.k_bl.id)");
    }
}
