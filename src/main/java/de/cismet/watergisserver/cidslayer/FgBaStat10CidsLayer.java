 ...
 */
public class FgBaStat10CidsLayer extends Default1505ConsideredCidsLayer {
     ...
     */
    public FgBaStat10CidsLayer(final MetaClass mc, final User user) {
//        super(mc, user);
        super(
            mc,
            user,
            ...
            null,
            false,
            " left join dlm25w.k_ww_gr dlm25wPk_ww_gr1 on (dlm25w.fg_ba_stat_10.ww_gr = dlm25wPk_ww_gr1.ww_gr)");
    }
