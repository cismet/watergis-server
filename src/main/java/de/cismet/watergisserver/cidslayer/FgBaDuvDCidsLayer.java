 ...
 */
public class FgBaDuvDCidsLayer extends Default1505ConsideredCidsLayer {
     ...
     */
    public FgBaDuvDCidsLayer(final MetaClass mc, final User user) {
        super(
            mc,
            user,
            false,
    ...
    protected boolean hasAttributeReadPermission(final String column, final User user) {
        if (column.equals("duv.fg_ba_duv_d.material")
                    || column.equals("duv.fg_ba_duv_d.obj_nr_gu")
                    || column.equals("duv.fg_ba_duv_d.traeger")
                    || column.equals("duv.fg_ba_duv_d.traeger_gu")
                    || column.equals("duv.fg_ba_duv_d.ausbaujahr")) {
            return ((user != null)
    ...
    protected String getFieldRestriction(final String column) {
        if (column.equals("duv.fg_ba_duv_d.zust_kl")
                    || column.equals("duv.fg_ba_duv_d.bemerkung")
                    || column.equals("duv.fg_ba_duv_d.br_dm_li")
                    || column.equals("duv.fg_ba_duv_d.ho_li")
                    || column.equals("duv.fg_ba_duv_d.br_tr_o_li")
                    || column.equals("duv.fg_ba_duv_d.ho_e")
                    || column.equals("duv.fg_ba_duv_d.ho_a")
                    || column.equals("duv.fg_ba_duv_d.gefaelle")
                    || column.equals("duv.fg_ba_duv_d.ho_d_e")
                    || column.equals("duv.fg_ba_duv_d.ho_d_a")
                    || column.equals("duv.fg_ba_duv_d.ho_d_m")) {
