 ...
 */
public class Dlm25wFgBakAeExtensionFactory extends ObjectExtensionFactory {

    //~ Static fields/initializers ---------------------------------------------

    private static final Logger LOG = Logger.getLogger(Dlm25wFgBakAeExtensionFactory.class);
    ...
    public void extend(final CidsBean bean) {
        try {
            final CidsBean wwGrBean = (CidsBean)bean.getProperty("bak_st.von.route.ww_gr");
