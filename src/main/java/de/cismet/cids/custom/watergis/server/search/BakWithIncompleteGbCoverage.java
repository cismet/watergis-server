 ...
 */
public class BakWithIncompleteGbCoverage extends AbstractAnalyzeSearch {
     ...
     */
    public BakWithIncompleteGbCoverage(final String owner, final int[] ids, final boolean export) {
