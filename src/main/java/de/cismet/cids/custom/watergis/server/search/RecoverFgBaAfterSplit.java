 ...
 */
public class RecoverFgBaAfterSplit extends AbstractCidsServerSearch {
    ...
    private static final String QUERY = "select dlm25w.recover_fg_ba_after_split(%1$s, %2$s);"; // NOI18N
