 ...
 */
public class AllGewOffenByGem extends AbstractCidsServerSearch {
     ...
     */
    public AllGewOffenByGem(final int[] routeIds, final int[] wdmArray) {
        this.gemId = 0;
     ...
     * @param  wdmArray  DOCUMENT ME!
     */
    public AllGewOffenByGem(final int gemId, final int[] routeIds, final int[] wdmArray) {
        this.gemId = gemId;
        this.routeIds = routeIds;
        this.wdmArray = wdmArray;
    }
