 ...
 */
public class MergeLawa extends AbstractCidsServerSearch {
    ...
    private static final String QUERY_WITHOUT_OWNER =
        "select dlm25w.merge_fg_lak_ae(null), dlm25w.merge_fg_bak_gwk(null);";                                     // NOI18N
    private static final String QUERY = "select dlm25w.merge_fg_lak_ae('%1$s'), dlm25w.merge_fg_bak_gwk('%1$s');"; // NOI18N
