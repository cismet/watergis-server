...
public class AllGewOffenByGeom extends AbstractCidsServerSearch {
     ...
     */
    public AllGewOffenByGeom(final int[] routeIds, final int[] wdmArray, final Geometry geom) {
        this.geom = geom;
